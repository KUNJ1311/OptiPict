...
const Preview = (props) => {
	...
	return (
		<>
			...
			<button type="button" onClick={handleCompress} className={styles.uploader_btn} title="Add more images" data-title="Add more images" style={{ display: `${props.showPreview ? "flex" : "none"}`, position: "relative", zIndex: "1" }}>
